...
public interface DeferredManager {
	 ...
	 *
	 * If the item is an unknown type, it'll throw an {@link IllegalAccessException}
	 *
	 * @param iterable
	 * @throws IllegalAccessException if any item in iterable cannot be converted to a {@link Promise}
	 * @return
	 */
