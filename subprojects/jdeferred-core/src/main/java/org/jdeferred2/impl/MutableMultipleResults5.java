...
/**
 * Contains 5 instances of {@link OneResult}.
 *
 * @author Ray Tsang
 * @author Andres Almiray
 * @author Domen
 */
class MutableMultipleResults5<V1, V2, V3, V4, V5> extends AbstractMutableMultipleResults implements MutableMultipleResults, MultipleResults5<V1, V2, V3, V4, V5> {
